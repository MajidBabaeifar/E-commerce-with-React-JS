                                    ...
                                    <div className="col-6 col-md-4 col-lg-4">
                                        <div className="product product-7 text-center">
                                            ...
                                            <div className="product-body">
                                                ...
                                                <h3 className="product-title"><a href="product.html">Brown paperbag waiset pencil skirt</a></h3>{/* End .product-title */}
                                    ...
                                    <div className="col-6 col-md-4 col-lg-4">
                                        <div className="product product-7 text-center">
                                            ...
                                            <div className="product-body">
                                                ...
                                                <h3 className="product-title"><a href="product.html">Black soft RI weekend travel bag</a></h3>{/* End .product-title */}
                                                <div className="product-price">
                                                    $68.00
                                                </div>{/* End .product-price */}
                                                <div className="ratings-container">
